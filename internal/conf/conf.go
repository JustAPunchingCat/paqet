...
type Hopping struct {
	...
	// auto-rotate fires. Default 15 (the middlebox "cold" window — a fresh
	// NAT mapping's return path is throttled ~10-15s until it matures, so a
	// lower threshold abandons fresh ports before they warm and churns).
